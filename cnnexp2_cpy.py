...
def adjust_prev_data_sample():
    move_files(path + "train/cats", data_dir + "/train", "*")
    move_files(path + "train/dogs", data_dir + "/train", "*")
    move_files(path + "valid/cats", data_dir + "/train", "*")
    move_files(path + "valid/dogs", data_dir + "/train", "*")
    #
...
def adjust_prev_data():
    move_files(data_dir + "/valid", data_dir + "/train", "*")
