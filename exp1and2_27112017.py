...
def run_experiment2(nepoch, batch_size, tr_model, retrain_size):
    another = False
    ...
    if get_file_count(path + "/unlabel/cats") + get_file_count(path + "/unlabel/dogs") >= retrain_size:
        another = True
...
if __name__ == "__main__":
    ...
    another = True
    while another:
        probs, test_batches, loss, accuracy, train_size, valid_size, another, tr_model  = run_experiment2(nepoch, batch_size, tr_model, block_size * 2)
